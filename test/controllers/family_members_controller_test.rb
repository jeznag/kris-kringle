...
class FamilyMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family_member" do
    assert_difference('FamilyMember.count') do
      post family_members_url, params: { family_member: { name: @family_member.name, partner: @family_member.partner, type: @family_member.type } }
    end
  ...
  test "should update family_member" do
    patch family_member_url(@family_member), params: { family_member: { name: @family_member.name, partner: @family_member.partner, type: @family_member.type } }
